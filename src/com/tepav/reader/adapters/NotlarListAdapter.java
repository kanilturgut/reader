 ...
 * Time: 17:26
 */
public class NotlarListAdapter extends ArrayAdapter<Yayin> implements YayinServiceDelegate {
    ...
    public NotlarListAdapter(Context context) {
    ...
    public void yayinListRequestDidFinish(Map responseMap) {
        yayinList = (ArrayList<Yayin>) responseMap.get("notList");
