 ...
 * Time: 17:27
 */
public class BasiliYayinListAdapter extends ArrayAdapter<Yayin> implements YayinServiceDelegate {
    ...
    public BasiliYayinListAdapter(Context context) {
    ...
    public void yayinListRequestDidFinish(Map responseMap) {
        yayinList = (ArrayList<Yayin>) responseMap.get("basılıYayinList");
